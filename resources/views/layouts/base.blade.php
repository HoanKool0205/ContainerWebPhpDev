...
<body class="home-page home-01 ">
				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: (+123) 456 789" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: (+84) 398209052</a>
								</li>
							</ul>
						</div>
	...
	<!-- API KEY -->
	<script src="https://cdn.tiny.cloud/1/7kju2jvck030gdgtfw7mv8fstgvgbhnpypslolvgwrsrac7c/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
