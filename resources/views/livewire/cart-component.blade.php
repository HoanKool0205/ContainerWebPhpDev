						...
						<div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
							...
							<div class="product product-style-2 equal-elem ">
								...
								<div class="product-info">
									<a href="#" class="product-name"><span>Laptop Dell</span></a>
							...
							<div class="product product-style-2 equal-elem ">
								...
								<div class="product-info">
									<a href="#" class="product-name"><span>Air purifier</span></a>
							...
							<div class="product product-style-2 equal-elem ">
								<div class="product-thumnail">
									<a href="#" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
										<figure><img src="{{ asset('assets/images/products/digital_2.jpg') }}" width="214" height="214" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
									</a>
									<div class="group-flash">
										<span class="flash-item new-label">new</span>
										<span class="flash-item sale-label">sale</span>
								...
								<div class="product-info">
									<a href="#" class="product-name"><span>SamSung Galaxy S9 Untral</span></a>
									<div class="wrap-price"><ins><p class="product-price">$168.00</p></ins> <del><p class="product-price">$250.00</p></del></div>
								</div>
							</div>
							...
							<div class="product product-style-2 equal-elem ">
								...
								<div class="product-info">
									<a href="#" class="product-name"><span>SamSung Note 2</span></a>
									<div class="wrap-price"><span class="product-price">$250.00</span></div>
								</div>
							</div>
							...
							<div class="product product-style-2 equal-elem ">
								...
								<div class="product-info">
									<a href="#" class="product-name"><span>Smart Camera</span></a>
									<div class="wrap-price"><span class="product-price">$250.00</span></div>
								</div>
							</div>
							...
							<div class="product product-style-2 equal-elem ">
								...
								<div class="product-info">
									<a href="#" class="product-name"><span>Radiant-360 R6 </span></a>
									<div class="wrap-price"><ins><p class="product-price">$168.00</p></ins> <del><p class="product-price">$250.00</p></del></div>
								</div>
							</div>
							...
							<div class="product product-style-2 equal-elem ">
								...
								<div class="product-info">
									<a href="#" class="product-name"><span> Speaker</span></a>
									<div class="wrap-price"><span class="product-price">$250.00</span></div>
								</div>
							</div>
							...
							<div class="product product-style-2 equal-elem ">
								...
								<div class="product-info">
									<a href="#" class="product-name"><span>Wireless Omnidirectional Speaker [White]</span></a>
									<div class="wrap-price"><span class="product-price">$250.00</span></div>
								</div>
							</div>
						</div>
