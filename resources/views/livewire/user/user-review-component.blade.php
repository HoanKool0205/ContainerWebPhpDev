                            ...
                            <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
                                <div id="comment-20" class="comment_container">
                                    @if($orderItem && $orderItem->product)
                                        <img src="{{ asset('assets/images/products') }}/{{ $orderItem->product->image }}" alt="{{ $orderItem->product->name }}" height="80" width="80">
                        ...
                        <div id="respond" class="comment-respond">
                            <form wire:submit.prevent="addReview" id="commentform" class="comment-form">
                                ...
                                <p class="comment-form-comment">
                                    ...
                                    @error('commit') <span class="text-danger">{{$message}}</span> @enderror
                                </p>
                                <p class="form-submit">
